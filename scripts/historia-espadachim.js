...
function select(sel) {
    ...
    switch (sel) {
        ...
        case 400:
            ...
            hero.nome = 'Caçadora'
            hero.hp = 40
            hero.sprite = './sprites/Bow.gif'
            hero.img = './img/img/Bow1.jpeg'
            hero.perfil = './img/rostoHero/rostoCacadora.png'
            hero.ataque = [18]
            hero.erro = 2
            hero.acerto = 6
            hero.crit = 11
            ...
            <div class="imagem-personagem"><img  src="../img/img/Bow1.jpeg"></div>
        ...
        case 402:
            ...
            <div class="historia-personagem"><p id="historia-cacadora">
            A tribo dos Caçadores foi uma das únicas que não participou da grande guerra, pela sua maioria respeitou o ciclo da vida; humanos haviam dominado a terra por milhares de anos, agora, era a sua vez de perecerem diante a uma ameaça descomunal. ${hero.nome}, entretanto, não fazia parte da maioria, rebelando-se contra as crenças de seus compatriotas, “Como vocês podem simplesmente sentarem e aguardarem a morte? Pessoas estão morrendo neste exato momento enquanto estamos isolados aqui!” Porém, quase todos não a escutavam, e os que escutavam, partiam da vila a fim de trazer alguma mudança, porém nunca mais voltavam.
        ...
        case 417:
            ...
            hero.dialogo = `<p>Lagartixa Falante:<span class="bossText">Como você ousa invadir o território de Lorde Ufattelig? Você é louca?!</span></p> <p>${hero.nome}:<span class="heroText">Olha só, nunca vi um animal falante! </span></p> 
            <p> Largatixa Falante: <span class="bossText"> Vou te informar que eu sou descendente de um dragão de komodo, cuidado comigo!</p>
            </span>`
        ...
        case 421:
            ...
            hero.dialogo = `<p>${boss.nome} :<span class="bossText">Quem é você? Quem ousa pisar no território de Securis, serva de Ufattelig?</span></p> <p>${hero.nome}:<span class="heroText">Uau, suas roupas são muito lindas, e limpas! Posso pegar?</span></p> 
            <p> ${boss.nome} : <span class="bossText"> Eu te ordeno a ajoelhar-se agora perante sua princesa, relés bárbara!</p></span>`

            audio = new Audio('./music/princessMusic.mp3')
            audio.play()

            hero.historia = 'select(422)'
        ...
        case 423:
            ...
            hero.dialogo = `<p> ${boss.nome} :<span class="bossText">Como você encontrou esse lugar? Eu tive certeza de contar apenas aos oficiais de Ufattelig! Não pode ser…</span></p> <p>${hero.nome}:<span class="heroText">Velhinho, eu não quero bater em você, só quero matar um tal de Ufafa lá</span></p> 
            <p> ${boss.nome} : <span class="bossText">Impossível! Você não vai passar!</p></span>`
        ...
        case 429:
            ...
            hero.dialogo = `<p> ${boss.nome}: <span class="bossText">Guerreira! Dê meia volta imediatamente, lhe aviso que mais um passo, e eu lhe corto em vários pedaços que nem uma melância do Fruit Ninja!</span></p> <p>${hero.nome}:<span class="heroText">Ei, armadura feiosa, cadê seu chefe, eu desafio ele para um x1!</span></p> 
            <p> ${boss.img}: <span class="bossText">Bela piada, vamos ver se você consegue cuspir mais palavras decapitada!</p></span>`
        ...
        case 435:
            ...
            hero.dialogo = `<p>${boss.nome}: <span class="bossText">Saudações, guerreira. Perdão pela minha falta de sutileza, porém como você derrotou vários oficiais de Ufattelig, fui encarregado de formalmente acabar com a sua raça, da forma mais rápida possível.</span></p> <p>${hero.nome}: <span class="heroText">Mago! Vamos acertar as contas, seu privilegiado mimado, você nunca teve dificuldades na sociedade por causa do seu jeito de lutar!</span></p> 
            <p> ${boss.nome}: <span class="bossText">Absurdo, eu só tive um empréstimo pequeno de um milhão, o resto foi tudo eu que adquiri!</p></span>`
        ...
        case 438:
            ...
            container.innerHTML = `
                ...
                A curiosidade tomou controle das ações de ${hero.nome}, que lhe forçou a acabar com a aventura, simplesmente para checar uma terrinha mais preta que o normal, e então ela vagou na terra sem fim, e morreu de fome e sede por não saber para onde ir, Fim!
                Brincadeira. 
                O que havia encontrado de fato, era um dragão negro com escamas vermelhas espalhadas pelo seu corpo, com uma altura de cinco metros, deitado como um animal de estimação na terra queimada do local, dormindo. 
        ...
        case 440:
            ...
            hero.dialogo = `<p> ${boss.nome}: <span class="bossText">CRIATURA INSOLENTE, OUSASTE DESFERIR SUA LAMINA FÉTIDA CONTRA MINHA NOBRE CARNE?</span></p> <p>${hero.nome}: <span class="heroText">Até o largartão parecia mais desafiante que você! </span></p> 
            <p> ${boss.nome}: <span class="bossText">IREI LHE MOSTRAR O QUE ACONTECE QUANDO UM MERO BÍPEDE XEXELENTO DESAFIA O REI DOS CÉUS!</p></span>`
        ...
        case 442:
            ...
            container.innerHTML = `
                ...
                Adentrar o castelo fora mais fácil do que parecia. Seus servos, que pareciam ser a sua força focal, alguns extremamente fortes, não estavam mais no castelo. ${hero.nome} estava ocupada demais com seus próprios pensamentos de glória, do que preocupadoa de saber o que estava acontecendo, será mesmo que o rei do mal simplesmente decidiu desocupar o castelo? Ou seria aquele um pedido de encontro entre os dois? 	Vários cenários indicavam que algo estava errado. Ele não havia dominado o mundo por simples força, suas táticas eram impecáveis, o que ele estava pensando?
        ...
        case 444:
            ...
            container.innerHTML = `
                ...
                ${hero.nome} era incapaz de entender o que o oponente estava tentando dizer, cada palavra soava como estática em seus ouvidos, mas aquilo não importava. Em sua cabeça, podia vencer sozinha sem mesmo ter que esperar pelo guardião, a vitória seria certa. 
