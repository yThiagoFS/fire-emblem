    ...
    switch(sel){
        ...
        case 400:
            ...
            case 419:
                ...
                <button class="botao-historia" type="button" onclick="select(420)"> Continuar</button>
            ...
            */
            ...
            case 425:
                ...
                <button class="botao-historia" type="button" onclick="select(425)"> Irei lutar contra o segundo melhor espadachim, quero dar um pouco de retribuição de todo esse tempo que fomos isolados!</button>

                <button class="botao-historia" type="button" onclick="select(431)">  Irei lutar contra o mago real, tenho umas coisas para acertar com esse privilegiado.</button>
            ...
            case 425:
                ...
                <button class="botao-historia" type="button" onclick="select(426)"> Continuar </button>
            ...
            case 429:
                ...
                <button class="botao-historia" type="button" onclick="select(430)"> Continuar </button>
            ...
            case 430:
                ...
                <button class="botao-historia" type="button" onclick="select(441)"> Não posso me distrair agora, por mais que eu queira muito, muito, muito ir… Não posso! Cada segundo importa, e não sei se o Ufattelig sei lá, pula da janela pra fugir! </button>
            ...
            case 431:
                ...
                <button class="botao-historia" type="button" onclick="select(432)"> Continuar </button>
            ...
            case 435:
                ...
                <button class="botao-historia" type="button" onclick="select(436)"> Continuar </button>
            ...
            case 437:
                ...
                <button class="botao-historia" type="button" onclick="select(438)"> Se eu conseguir um título de caçador de dragões, terei tudo o que quero! </button>
            ...
            case 438:
                ...
                <button class="botao-historia" type="button" onclick="select(439)"> Continuar </button>
            ...
            case 440:
                ...
                <button class="botao-historia" type="button" onclick="select(441)"> Continuar </button>
            ...
            case 447:
                ...
                <button class="botao-historia" type="button" onclick="select(448)"> Continuar </button>
